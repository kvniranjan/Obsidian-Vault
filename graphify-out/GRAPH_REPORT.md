...
## Corpus Check
- 127 files · ~70,237 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 423 nodes · 576 edges · 32 communities detected
- Extraction: 83% EXTRACTED · 17% INFERRED · 0% AMBIGUOUS · INFERRED: 97 edges (avg confidence: 0.79)
...
2. `LangGraph - AI Agent Orchestration Framework` - 15 edges
3. `BA GitHub Discovery Tracked Repos Index` - 15 edges
4. `FlexCube Brazil Payments Project` - 15 edges
5. `CrewAI - Role-Based Multi-Agent Orchestration Framework` - 13 edges
6. `Camunda BPMN Process Orchestration Platform` - 13 edges
7. `ECS Plus Partner Integration` - 13 edges
8. `dmnmd - DMN Decision Tables in Markdown` - 12 edges
9. `bpmn.io Web Modeler` - 11 edges
10. `Drools - Apache KIE Rule and DMN Engine` - 10 edges

## Surprising Connections (you probably didn't know these)
- `rmToo - Git-Native Requirements Management` --semantically_similar_to--> `Doorstop YAML Requirements Management`  [INFERRED] [semantically similar]
  BA Skills/rmToo - Git-Native Requirements Management Tool.md → Granola Meeting Notes/2026-03-29 GitHub BA Tool.md
- `MetaGPT Multi-Agent Framework` --semantically_similar_to--> `Specifai AI Requirements Document Generator`  [INFERRED] [semantically similar]
  BA Skills/MetaGPT - Multi-Agent Requirements and Document Generation Framework.md → Granola Meeting Notes/2026-03-19 GitHub BA Tool.md
- `Specifai AI Requirements Document Generator` --semantically_similar_to--> `Requirements Structuring CLI (LLM-powered)`  [INFERRED] [semantically similar]
  Granola Meeting Notes/2026-03-19 GitHub BA Tool.md → BA Skills/PM Tools Templates - Comprehensive BA Template Library.md
- `OSRMT Open Source Requirements Management` --semantically_similar_to--> `Doorstop YAML Requirements Management`  [INFERRED] [semantically similar]
  BA Skills/OSRMT - Open Source Requirements Management Tool.md → Granola Meeting Notes/2026-03-29 GitHub BA Tool.md
- `Agentic AI in Payments` --semantically_similar_to--> `PayPal and OpenAI Agentic Commerce Protocol`  [INFERRED] [semantically similar]
  Granola Meeting Notes/Newsletters/2026-03-17 AI Newsletter.md → Granola Meeting Notes/Newsletters/2026-03-24 AI Newsletter.md

## Hyperedges (group relationships)
- **AI Agent Orchestration Frameworks for BA (LangGraph, CrewAI, Semantic Kernel)** — langgraph_skill, crewai_skill, semantic_kernel_skill, multi_agent_orchestration, brd_document_generation [INFERRED 0.90]
- **BPMN Process Automation Stack (BPMN Assistant + SpiffArena + DMN)** — bpmn_assistant_skill, spiffarena_skill, dmn_decision_tables, bpmn_notation, spiffworkflow_engine [EXTRACTED 0.92]
- **Copilot Content Transformation Prompt Suite** — summarize_prompt, make_shorter_prompt, make_longer_prompt, simplify_prompt, explain_like_5_prompt, fix_grammar_spelling_prompt [INFERRED 0.85]
- **BPMN+DMN Executable Process Stack** — camunda_platform, flowable_engine, drools_engine, bpmn20_standard, dmn_standard [INFERRED 0.88]
- **Requirements Management Tools Ecosystem** — rmtoo_tool, osrmt_tool, doorstop_tool, pmtemplates_library, osrmt_rtm, rmtoo_traceability [INFERRED 0.85]
- **Agile Ceremony and Backlog Management Toolset** — thunderdome_suite, featmap_tool, ploiroadmap_tool, thunderdome_planningpoker, thunderdome_retrospective, thunderdome_storymapping [INFERRED 0.82]
- **Open-Source BA Tools Integrated via Obsidian Workflow** — ba_tool_penpot, ba_tool_plane, ba_tool_meetingmind, ba_tool_storymachine, ba_tool_log4brains, ba_tool_pm4py, ba_tool_ydata_profiling, ba_tool_ploi_roadmap, ba_tool_bpmn_assistant, concept_ba_workflow_obsidian, concept_open_source_selfhost [INFERRED 0.90]
- **FlexCube Projects and Agentic Payment Infrastructure Convergence** — concept_flexcube_brazil_payments, concept_ecs_plus_integration, concept_qfi_flexcube, concept_agentic_payments, concept_oracle_agentic_banking [EXTRACTED 0.95]
- **BFSI AI Governance: Regulatory Frameworks, Governance Gaps, and Systemic Risk** — concept_ai_governance_bfsi, concept_fs_ai_rmf, concept_finra_ai_governance, concept_boe_fpc_ai_systemic_risk, concept_eu_ai_act_credit, concept_us_national_ai_framework [INFERRED 0.88]
- **Brazil FlexCube Payment Ecosystem: Earmarking, Consolidated Posting, and Green Zone** — project_flexcube_brazil_payments, concept_earmarking_workflow, concept_consolidated_posting, concept_green_zone_booking, concept_book_to_book_4leg [EXTRACTED 0.92]
- **Genesis, TRL, and PI Planning Release Coordination Cluster** — project_genesis_release, project_trl_upgrade, project_pi_planning, concept_genesis_migration_delays, concept_oracle_citi_acquisition [EXTRACTED 0.88]
- **BFSI AI Governance and Regulatory Framework Cluster** — concept_treasury_fs_ai_rmf, concept_state_insurance_ai_eval_tool, concept_fed_reserve_ai_operationalization, concept_armilla_ai_liability [INFERRED 0.82]
- **Brazil Payment Ecosystem - FlexCube, ECS Plus, Amcar, and Float Account Integration** — concept_flexcube_brazil_payments, concept_ecs_plus_partner_integration, concept_amcar_integration, concept_float_account_mapping, concept_payment_hub_integration [INFERRED 0.87]
- **LATAM Partial Earmark - FlexCube, C900, and HVA Architecture Integration** — concept_partial_earmark, concept_c900_system, concept_hva_nonhva_architecture, concept_flexcube_brazil_payments [EXTRACTED 0.92]
- **ECS Plus UAT Deployment - Kafka JSON, EOD/SOD Notification, and QFI Integration** — concept_ecs_plus_partner_integration, concept_kafka_json_model, concept_eod_sod_notification, concept_qfi_flexcube_integration [EXTRACTED 0.88]
- **Brazil Payments Integration: FlexCube, ECS Plus, and Sweeps Implementation** — flexcube_brazil_payments, brazil_ecs_plus_testing, brazil_seven_day_sweeps, brazil_advanced_earmarking [INFERRED 0.85]
- **Anthropic Mythos Triggers Global Financial Regulatory Response** — anthropic_mythos, project_glasswing_mythos, hkma_mas_ai_cyber_framework, boe_ai_stress_tests, mythos_bessent_powell_summit [EXTRACTED 0.92]
- **Agentic Commerce Trust and Payment Infrastructure Ecosystem** — visa_intelligent_commerce, fime_fact_agentic_trust, agentic_commerce_card_infrastructure, bank_of_bots, bot_permission_authentication [INFERRED 0.78]
...
- **Are the 2 inferred relationships involving `LangGraph - AI Agent Orchestration Framework` (e.g. with `CrewAI - Role-Based Multi-Agent Orchestration Framework` and `Semantic Kernel - Microsoft Enterprise AI Agent SDK`) actually correct?**
  _`LangGraph - AI Agent Orchestration Framework` has 2 INFERRED edges - model-reasoned connections that need verification._
- **Are the 3 inferred relationships involving `FlexCube Brazil Payments Project` (e.g. with `Customer Name Special Character Defect - Flex/CDP Parsing` and `Blind Key - Maker/Checker Field Masking for EPIC Countries`) actually correct?**
  _`FlexCube Brazil Payments Project` has 3 INFERRED edges - model-reasoned connections that need verification._
- **Are the 2 inferred relationships involving `CrewAI - Role-Based Multi-Agent Orchestration Framework` (e.g. with `LangGraph - AI Agent Orchestration Framework` and `Semantic Kernel - Microsoft Enterprise AI Agent SDK`) actually correct?**
  _`CrewAI - Role-Based Multi-Agent Orchestration Framework` has 2 INFERRED edges - model-reasoned connections that need verification._